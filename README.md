...
Grok, OpenCode, Pi, Amp, Cursor CLI, Gemini, Antigravity, Rovo Dev, Copilot,
CodeBuddy, Factory, and Qoder. Claude Code is handled by the cmux Claude wrapper when Claude
