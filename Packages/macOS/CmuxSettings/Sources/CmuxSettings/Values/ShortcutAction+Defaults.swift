...
extension ShortcutAction {
    ...
    public var defaultStroke: ShortcutStroke? {
        ...
        case .globalZoomIn: return ShortcutStroke(key: "=", command: true, shift: true)
        case .globalZoomOut: return ShortcutStroke(key: "-", command: true, shift: true)
        case .globalZoomReset: return ShortcutStroke(key: "0", command: true, shift: true)
