...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "markdown-background", String(localized: "settings.app.markdownBackground", defaultValue: "Markdown Viewer Background"), "markdown.background md markdown viewer background canvas page solid terminal transparent theme contrast"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "markdown.background": settingID(for: .app, idSuffix: "markdown-background"),
