...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "app:markdown-background": localized("settings.search.alias.setting.app.markdown-background", defaultValue: "markdown.background md markdown viewer background canvas page solid terminal transparent see-through theme contrast readable"),
